...
h = np.load("/Users/tamaldas/Documents/Scripts/Python/serdespy-main/examples/example_channel/data/h_ctle.npy")
# t = np.load("/Users/tamaldas/Documents/Scripts/Python/serdespy-main/examples/example_channel/data/t.npy")
